...
public class BounceController : MonoBehaviour {
    ...
    void OnCollisionEnter(Collision other)
    {
        ...
        if(other.collider.tag=="Mur")
        {
            //checkCollision = true;
            Explosion(gameObject, GetComponent<Rigidbody>().velocity);
        ...
        if(other.collider.tag!="Mur"&& other.collider.tag!="Player")
        {
            checkCollision = true;
        }
    }
